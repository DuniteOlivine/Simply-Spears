...
public class DiamondSpearModel extends Model {
    public static final ModelLayerLocation DIAMOND_LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(SimplySpears.MODID,"diamond_spear"),"main");
    ...
    public void setupAnim(ThrownDiamondSpear entity){
